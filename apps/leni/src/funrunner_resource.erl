...
to_html(ReqData, Context) ->
	...
	{FN, Command, Comment} = get_fun_for_funname(Node, Fun_name),
	{ok, Content} = funrunner_dtl:render([{fun_name, FN},{command, Command}, {comment, Comment}]),
