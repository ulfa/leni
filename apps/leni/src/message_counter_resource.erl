...
-module(message_counter_resource).
...
to_html(ReqData, Context) ->	
	...
	Module_config = get_module_config(list_to_atom(Node), Name),
	{ok, Content} = message_counter_dtl:render(lists:append([{node, Node},{name, Name}], Module_config)),
    {Content, ReqData, Context}.  

get_module_config(Node, Name) ->
