...
to_html(ReqData, Context) ->
	{ok, Content} = sensors_dtl:render([{sensors, get_sensors(nodes())}]),
    {Content, ReqData, Context}. 

get_sensors(Nodes) ->
	{Result, BN} = rpc:multicall(Nodes, horst, get_things, [sensor], 1000),
